...
Project-specific instructions for AI coding agents (Claude Code, Codex, etc.) working in this repository. See also `CONTEXT.md` (learning progress/session log) and `README.md` (project overview).
